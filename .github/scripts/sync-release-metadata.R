...
#
# Ported from ../quartifyr's .github/scripts/sync-release-metadata.R
# (itself ported from ../xpose.xtras) -- this file is package-agnostic
# (Package is read from DESCRIPTION, not hardcoded), so it carried over
# unmodified.
